...
import { exchangeMarketDataRoutes } from "./exchange-market-data.js";
...
export const allRoutes = [
  ...
  ...webhookRoutes, ...internalRoutes, ...exchangeWalletRoutes, ...exchangeOrderRoutes, ...exchangeMarketDataRoutes, ...docsRoutes,
];
